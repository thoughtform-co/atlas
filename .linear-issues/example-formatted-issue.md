# Example: Formatted Linear Issue

**Issue ID:** THO-49  
**Title:** Fix EntityCard and DenizenModal spacing issues

---

## Problem

Text spacing in EntityCard and DenizenModal components is too close to borders, creating a cramped visual appearance that doesn't match design specifications.
...
Converted all spacing values from Tailwind rem-based classes to hard pixel values matching the HTML mockups exactly:
...
All values now use inline styles with hard pixel values to eliminate font-size scaling drift.
...
- Created interactive HTML mockups in `design/mockups/` to test spacing values
